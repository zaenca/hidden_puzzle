...
## Элемент процедурной комнаты, по которому берётся область слота. Дверь,
## нарисованную комнатой, игрок обязан нажимать ровно там, где она нарисована;
## подогнанный руками rect при смене шаблона геометрии уезжает с неё, и это
## обнаруживается уже пальцем.
@export var room_element: String = ""
