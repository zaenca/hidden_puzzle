...
## Шаги обучения для игрового модуля — сырые словари из content/tutorial.
## Пусто — обучение не показывается. Решает мета: какой файл читать, написано
## в данных уровня, а «показывали ли уже» знает только она.
